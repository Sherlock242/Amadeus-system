...
export const kurisuExpressions: Record<string, string[]> = {
  ...
  'angry':               [`${IMAGE_PATH}kurisu_angry1.png`,              `${IMAGE_PATH}kurisu_angry2.png`,              `${IMAGE_PATH}kurisu_angry3.png`],
  ...
  'talking':             [`${IMAGE_PATH}kurisu_sided_talking1.png`,      `${IMAGE_PATH}kurisu_sided_talking2.png`,      `${IMAGE_PATH}kurisu_sided_talking3.png`],

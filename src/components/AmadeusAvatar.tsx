      ...
      <div>
        ...
        <div className="relative flex justify-center items-center my-8 h-48">
          ...
          <svg width="200" height="200" viewBox="0 0 200 200" className="absolute">
            ...
            <circle cx="100" cy="100" r="90" fill="none" stroke="url(#grad1)" strokeWidth="1" strokeDasharray="10 15" opacity="0.5" className="animate-spin-slow" style={{transformOrigin: 'center'}} />
            <circle cx="100" cy="100" r="80" fill="none" stroke="#ff8c00" strokeWidth="0.5" opacity="0.7" className="animate-spin-slow-reverse" style={{transformOrigin: 'center'}} />
            <g className="animate-pulse-glow" style={{filter: 'url(#glow)'}}>

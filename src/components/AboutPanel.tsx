    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="glass-panel rounded-lg p-6 max-w-2xl w-full relative">
        ...
        <div className="space-y-4 text-amber-100/90 font-sans leading-relaxed">
          ...
          <p>
            The core of this AI is powered by <strong className="text-white">Google's Gemini API</strong>, configured to embody Kurisu's unique personality—her intelligence, scientific passion, and her 'tsundere' nature.
          </p>
          <p>
